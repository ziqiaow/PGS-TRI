...
You can construct PGS for trios using weights available on previously reported sources trained in external data, such as [PGScatalog](https://www.pgscatalog.org/), following steps described for unrelated individuals using softwares such as PLINK/2.0.
